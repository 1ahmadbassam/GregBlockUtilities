...
public class GBRecipeMaps {
    ...
    static {
        SIEVE_RECIPES = new RecipeMapExtended<>("electric_sieve", 2, 2, 1, 28, 0, 0, 0, 0, new SimpleRecipeBuilder()).setProgressBar(GuiTextures.PROGRESS_BAR_SIFT, ProgressWidget.MoveType.HORIZONTAL);
